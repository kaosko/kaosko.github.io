var reversi = {
    ...
    initGame: function() {
        ...
        var centerX = Math.floor(this.rows / 2);
        var centerY = Math.floor(this.cols / 2);
        // init placement
        this.setItemState(centerX, centerY, this.states.white);
        this.setItemState(centerX, centerY + 1, this.states.black);
        this.setItemState(centerX + 1, centerY, this.states.black);
        this.setItemState(centerX + 1, centerY + 1, this.states.white);
